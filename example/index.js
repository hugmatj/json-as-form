          ...
          (!e || !t || ("object" != typeof e && "object" != typeof t)
            ...
            : (function(e, t, n) {
                ...
                var m = i(e),
                  d = i(t);
                if (m !== d) return !1;
                if (m || d) return e.source === t.source && c(e) === c(t);
    ...
    function(e, t, n) {
      ...
      t.default = function(e) {
        var t = e.json,
          ...
          _ =
            void 0 === k
              ...
              : k,
          R = Object(f.useRef)(!0),
          C = Object(f.useRef)(!Array.isArray(t)),
          P = Object(f.useState)([]),
          N = s()(P, 2),
          A = N[0],
          T = N[1];
        Object(f.useEffect)(
          function() {
            if (!1 !== R.current || !0 !== a)
              if (((C.current = !Array.isArray(t)), 1 == C.current)) {
                var e = D._parseJSON(j({}, t));
                m()(e, A) || T(e);
              } else if (
                (!l || (t && t.length) || (t = [D._getEmptyRowSkeleton()]),
                !m()(t, D._toJSON()))
              ) {
                var n = t.map(function(e) {
                  var t = j({}, e);
                  return t[x] || (t[x] = v.a.v4()), t;
                });
                console.log(n, 8889), T(i()(n));
              }
          },
          [t]
        ),
        ...
        var D = {
            _parseJSON: function() {
              ...
              return (
                !0 === l &&
                  t[n] &&
                  (t[n].key || t[n].value) &&
                  (t = [].concat(i()(t), [D._getEmptyRowSkeleton()])),
                t
              );
            },
            _toJSON: function() {
            ...
            _addNewRow: function() {
              T([].concat(i()(A), [D._getEmptyRowSkeleton()]));
            },
            _onChangeRow: function(e, t, n, r) {
              var o = A.map(function(r, o) {
                var a = j({}, r);
                return o === n && ((a.key = e), (a.value = t)), a;
              });
              T(
                r && !0 === l
                  ? [].concat(i()(o), [D._getEmptyRowSkeleton()])
                  : o
              );
            },
            ...
            _onRemoveRow: function(e) {
              var t = A.filter(function(t, n) {
                return n !== e;
              });
              t.length ? T(t) : T([D._getEmptyRowSkeleton()]);
            }
          },
          $ = p.a.createElement("span", { className: "start-brace" }, "{"),
          ...
          ? p.a.createElement(
              ...
              A.map(function(e, t) {
                ...
                return p.a.createElement(g, {
                  ...
                  onChange: function(e, n) {
                    return D._onChangeRow(e, n, t, r);
                  },
                  onToggleRowStatus: function(e) {
                    return D._onToggleRowStatus(e, t);
                  },
                  onRemoveRow: function() {
                    return D._onRemoveRow(t);
                  },
                  showCheckBox: !C.current,
                  rowInterpolator: _
                });
              }),
              ...
              S &&
                p.a.createElement(
                  "div",
                  null,
                  p.a.createElement("pre", null, JSON.stringify(A, 2, 2)),
      ...
      if (!Object.keys) {
        ...
        r = function(e) {
          ...
          if (r && e.length > 0)
            ...
            for (var b in e)
              (m && "prototype" === b) || !o.call(e, b) || p.push(String(b));
          if (u)
            for (
              var g = (function(e) {
      ...
      u.a.render(
        i.a.createElement(function() {
          ...
          return i.a.createElement(
            "div",
            null,
            i.a.createElement("h4", null, "Stateless Form"),
            ...
            i.a.createElement("br", null),
            i.a.createElement("br", null),
            i.a.createElement("h4", null, "Statefull Form"),
            i.a.createElement(l.default, {
              json: s,
              fixedKeys: [],
              debug: !1,
